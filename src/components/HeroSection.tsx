  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-ai-dark-gradient">
      ...
      <div className="absolute inset-0">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-ai-pink/10 to-transparent rounded-full blur-3xl animate-float"
